...
@Slf4j
@Data
@Document(collection = "product_retry_jobs")
public class ProductRetryJobDocument {
    ...
    public static ProductRetryJobDocument from(ProductRetryJob job) {
        ProductRetryJobDocument doc = new ProductRetryJobDocument();
    ...
    public static ProductRetryJobDocument fromSuccess(RetryJob job) {
        ProductRetryJobDocument doc = new ProductRetryJobDocument();
        doc.setId(job.getId() != null ? job.getId().toString() : null);
