...
@Slf4j
@Data
@Document(collection = "order_retry_jobs")
public class OrderRetryJobDocument {
    ...
    public static OrderRetryJobDocument from(OrderRetryJob job) {
        OrderRetryJobDocument doc = new OrderRetryJobDocument();
    ...
    public static OrderRetryJobDocument fromSuccess(RetryJob job) {
        OrderRetryJobDocument doc = new OrderRetryJobDocument();
        doc.setId(job.getId() != null ? job.getId().toString() : null);
